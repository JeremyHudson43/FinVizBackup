...
stock_list_three = Screener(filters=['ta_sma200_pa', 'sh_avgvol_o500', 'sh_price_u10', 'ind_stocksonly', 'ipodate_more1',
                                     'sh_float_u50'],
...
try:
    ...
    df.to_csv(f'{path}\\combined_both_penny.csv', index=False)
